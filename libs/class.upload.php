...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['file_error'] = 'Error en el archivo. Por favor intentalo de nuevo.';
        $this->translation['local_file_missing'] = 'El archivo local no exite.';
        $this->translation['local_file_not_readable'] = 'No se puede leer el archivo local.';
        $this->translation['uploaded_too_big_ini'] = 'Error al subir el archivo (El archivo excede el tama&ntilde;o en las directivas del php.ini).';
        $this->translation['uploaded_too_big_html'] = 'Error al subir el archivo (El archivo excede el tama&ntilde;o en el formulario html).';
        $this->translation['uploaded_partial'] = 'Error al subir el archivo (El archivo fue subido parcialmente.).';
        $this->translation['uploaded_missing'] = 'Error al subir el archivo (El archivo no fue subido).';
        $this->translation['uploaded_no_tmp_dir'] = 'Error al subir el archivo (No se encuentra la carpeta temporal).';
        $this->translation['uploaded_cant_write'] = 'Error al subir el archivo (Error al tratar de escribir el archivo en el HDD).';
        $this->translation['uploaded_err_extension'] = 'Error al subir el archivo (Extensi&oacute;n no permitida).';
        $this->translation['uploaded_unknown'] = 'Error al subir el archivo (Error desconocido).';
        $this->translation['try_again'] = 'Error al subir el archivo. Por favor intentalo de nuevo.';
        $this->translation['file_too_big'] = 'Archivo demasiado grande';
        $this->translation['no_mime'] = 'Tipo MIME no puede ser detectado.';
        $this->translation['incorrect_file'] = 'Tipo de archivo incorrecto';
        $this->translation['image_too_wide'] = 'Imagen muy ancha';
        $this->translation['image_too_narrow'] = 'Imagen muy larga.';
        $this->translation['image_too_high'] = 'Imagen muy alta.';
        $this->translation['image_too_short'] = 'Imagen muy peque&ntilde:a.';
        $this->translation['ratio_too_high'] = 'El radio de la imagen es muy amplio.';
        $this->translation['ratio_too_low'] = 'El radio de la imagen es muy corto.';
        $this->translation['too_many_pixels'] = 'Imagen con demasiados puntos por pixel.';
        $this->translation['not_enough_pixels'] = 'La imagen no tiene suficientes puntos por pixel.';
        $this->translation['file_not_uploaded'] = 'Error al subir el archivo. No se puede realizar el proceso.';
        $this->translation['already_exists'] = '%s ya existe. Por favor cambie el nombre del archivo.';
        $this->translation['temp_file_missing'] = 'La fuente del archivo temporal no es correcta. No se puede realizar el proceso.';
        $this->translation['source_missing'] = 'El archivo subido no es correcto. No se puede realizar el proceso.';
        $this->translation['destination_dir'] = 'La carpeta de destino no puede ser creada. No se puede realizar el proceso.';
        $this->translation['destination_dir_missing'] = 'La carpeta de destino no exite. No se puede realizar el proceso.';
        $this->translation['destination_path_not_dir'] = 'La ruta de destino no es una carpeta. No se puede realizar el proceso.';
        $this->translation['destination_dir_write'] = 'La carpeta de destino no puede ser sobreescrita. No se puede realizar el proceso.';
        $this->translation['destination_path_write'] = 'La ruta de destino no puede ser sobreescrita. No se puede realizar el proceso.';
        $this->translation['temp_file'] = 'No se puede crear el archivo temporal. No se puede realizar el proceso.';
        $this->translation['source_not_readable'] = 'El archivo fuente no puede ser leido. No se puede realizar el proceso.';
        ...
        $this->translation['gd_missing'] = 'La libreria GD no esta presente.';
        $this->translation['watermark_no_create_support'] = 'No se crea soporte de %s , no se puede leer marca de agua.';
        $this->translation['watermark_create_error'] = 'No %s se lee soporte, no se puede crear marca de agua.';
        $this->translation['watermark_invalid'] = 'Formato de imagen desconocido, no se puede leer marca de agua.';
        $this->translation['file_create'] = 'No %s se crea soporte.';
        $this->translation['no_conversion_type'] = 'Tipo de conversi&oacute;n no definida.';
        $this->translation['copy_failed'] = 'Error copiando el archivo al servidor. El metodo copy() fallo.';
        $this->translation['reading_failed'] = 'Error leyendo el archivo.';
