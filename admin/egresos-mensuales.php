	...
	<script type="text/javascript">
		...
		google.setOnLoadCallback(drawChart);
			function drawChart() {
				...
				var options = {
					chart: {
						title: 'Egresos estimados mensuales en soles',
					},
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="navbar navbar-default">
						<div class="navbar-inner content-span">
							<span >Reporte de Egresos de dinero - Año: <?= isset($_POST['Consultar']) ? $_POST['year']:date('Y'); ?></span>
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
		                                ...
		                                <div class="col-xs-2">
		                                	...
		                                	?>
			                                <a class="btn btn-success" href="informe2.php/egresos/<?=$year?>/" target="_blank">
