$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'vehiculos/paginacionDinamicavehiculos', pagina , function(data) {
