$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'compras/paginacionDinamicacompras', pagina , function(data) {
...
function borrar_compra(id){
        ...
        fancyConfirm("Est&aacute; seguro que desea eliminar el registro?",
                function() {
                    var respuesta = $.post(_ruta_ + 'compras/eliminarcompra/'+ id);
...
function cambiar_estado(id){
        ...
        fancyConfirm("Est&aacute; seguro que desea Cambiar el estado del registro?",
                function() {
                    var respuesta = $.post(_ruta_ + 'compras/cambiar_estado/'+ id);
                    respuesta.done(function(data) {
                        if ($.isEmptyObject(data)) {
                                 window.location.reload();
                        } else {
