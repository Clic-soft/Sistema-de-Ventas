$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'insumos/paginacionDinamicainsumos', pagina , function(data) {
